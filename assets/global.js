...
class MenuDrawer extends HTMLElement {
  ...
  bindEvents() {
    ...
    // Allow clicking the details element itself (outside the menu-drawer inner content) to close the drawer
    this.mainDetailsToggle.addEventListener('click', (event) => {
      // If the click is directly on the details element (not on its children like nav, summary, etc.)
      if (
